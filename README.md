...
> **🧠 [苏格拉底教学法设计逻辑 — SOCRATIC_DESIGN.md](./SOCRATIC_DESIGN.md)**
>
> 从 25 篇论文到 3 条铁律的旅程。两次实验教学的真实复盘、LLM 教学失败模式的根源分析、B+C 防模式切换机制的设计过程。让 AI "闭嘴"比让它说话难一万倍——这是怎么做到的。

> **✒️ [叙事设计逻辑 — NARRATIVE_DESIGN.md](./NARRATIVE_DESIGN.md)**
>
> 一份让 AI 从 `*微微一笑*` 毕业的康复指南。每条写作红线背后的血泪教训、8 种不说"我很感动"的情绪表达工具、角色声音系统的 Do/Don't 设计哲学。

> **🤖 [AI 代理指南 — AI_GUIDE.md](./AI_GUIDE.md)**
>
...
**完整的架构设计和技术细节见 → [ARCHITECTURE.md](./ARCHITECTURE.md)** | **设计背后的故事 → [苏格拉底](./SOCRATIC_DESIGN.md) · [叙事](./NARRATIVE_DESIGN.md)** | **AI 代理？→ [AI_GUIDE.md](./AI_GUIDE.md)** | **想创建自己的系统？→ [META_PROMPT.md](./META_PROMPT.md)**
